...
angry_playlist = ["Aarambh Hai Prachand","Ghamand Kar","Tera Baap","ACDC-BackinBlack", "OhTheLarceny-ManonaMission", "LedZeppelin-ImmigrantSong",];
angry_title = ["Aarambh Hai Prachand","Ghamand Kar","Tera Baap","ACDC - Back in Black", "Oh The Larceny - Man on a Mission", "Led Zeppelin - Immigrant Song"];
angry_poster = ["static/song_imgs/Aarambh-Hai-Prachand.jpg","static/song_imgs/Ghamand-Kar.jpg","static/song_imgs/Tera-Baap.jpg","static/song_imgs/back_in_black.jpg", "static/song_imgs/man_on_a_mission.jpg", "static/song_imgs/immigrant_song.jpg"];

happy_playlist = ["The Desi Boyz","Jungle me Kaand","Pyaar Hota Kayi","WillPharrell-Happy", "Kool&TheGang-Celebration", "RickAstley-NeverGonnaGiveYouUp"];
happy_title = ["The Desi Boyz","Jungle me Kaand","Pyaar Hota Kayi","Will Pharrell - Happy", "Kool & The Gang - Celebration", "Rick Astley - Never Gonna Give You Up"];
happy_poster = ["static/song_imgs/The-Desi-Boys.jpg", "static/song_imgs/Jungle-me-Kaand.jpg", "static/song_imgs/Pyaar-Hota-Kayi.jpg", "static/song_imgs/happy.jpg", "static/song_imgs/celebration.jpg", "static/song_imgs/never_gonna_give_you_up.jpg"];

calm_playlist = ["Hua Hain Aaj","Dil Mein Chhupa","SmashMouth-AllStar", "DJOkawari-SpeedofLight", "BillieEilish-BadGuy"];
calm_title = ["Hua Hain Aaj","Dil Mein Chhupa","Smash Mouth - All Star", "DJ Okawari - Speed of Light", "Billie Eilish - Bad Guy"];
calm_poster = ["static/song_imgs/Hua-hai-aaj.jpg", "static/song_imgs/Dil-Mein-Chhupa.jpg", "static/song_imgs/all_star.jpeg", "static/song_imgs/speed_of_light.jpg", "static/song_imgs/bad_guy.jpg"];

sad_playlist = ["Let Me x Main Dhoondne","Phir Bhi","Adele-Hello", "CelineDion-MyHeartWillGoOn", "GaryJules-MadWorld"];
sad_title = ["Let Me x Main Dhoondne","Phir Bhi","Adele - Hello", "Celine Dion - My Heart Will Go On", "Gary Jules - Mad World"];
sad_poster = ["static/song_imgs/Let-Me-x-Main-Dhoondne.JPG", "static/song_imgs/Phir-Bhi.JPG", "static/song_imgs/hello.JPG", "static/song_imgs/my_heart_will_go_on.jpg", "static/song_imgs/mad_world.jpg"];
